...
describe('HomeMainComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(HomeMainComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(HomeMainComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('HomeMainView')
    })
