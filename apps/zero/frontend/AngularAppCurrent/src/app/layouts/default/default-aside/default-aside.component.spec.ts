...
describe('DefaultAsideComponent', () => {
  let cpnt: DefaultAsideComponent;
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(DefaultAsideComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(DefaultAsideComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('DefaultAsideView')
    })
