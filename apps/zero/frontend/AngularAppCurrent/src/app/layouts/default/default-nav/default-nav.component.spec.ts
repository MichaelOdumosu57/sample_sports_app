...
describe('DefaultNavComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(DefaultNavComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(DefaultNavComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('DefaultNavView')
    })
